...
const load = Vue.createApp({
  setup () {
    return {
      ...
      CarouselText2: 'Adding additional player data can be achieved by modifying the tmg-core player.lua file.',
      ...
      CarouselText4: 'For additional support please join our community at discord.gg/tmgcore',
